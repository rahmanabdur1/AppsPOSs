...
import FilterSupplier from "@/app/Components/FilterSupplier";
...
const SupplierTable: React.FC = () => {
  const [customersdata, setCustomersdata] = useState<ListItem[]>([
    { id: '1', label: 'Customer ID', checked: true },
    { id: '2', label: 'Customer (Image, Name, Designation)', checked: true },
    { id: '3', label: 'Company', checked: true },
    { id: '4', label: 'Designation', checked: true },
    { id: '5', label: 'Department', checked: true },
    { id: '6', label: 'Industry', checked: true },
    { id: '7', label: 'Email', checked: true },
    { id: '8', label: 'Mobile', checked: true },
    { id: '9', label: 'Phone', checked: true },
    { id: '10', label: 'Fax', checked: true },
    { id: '11', label: 'Country:-', checked: true },
    { id: '12', label: 'Address:-', checked: true },
    { id: '13', label: 'City:-', checked: true },
    { id: '14', label: 'State:-', checked: true },
    { id: '15', label: 'ZIP Code:-', checked: true },
    { id: '16', label: 'Tax Number:-', checked: true },
    { id: '17', label: 'GST Number:-', checked: true },
    { id: '18', label: 'Customer Type', checked: true },
    { id: '19', label: 'Sell Type', checked: true },
    { id: '20', label: 'Total', checked: true },
    { id: '21', label: 'Paid', checked: true },
    { id: '22', label: 'Due', checked: true },
    { id: '23', label: 'Create By', checked: true },
    { id: '24', label: 'Create Date', checked: true },
    { id: '25', label: 'Website', checked: true },
    { id: '26', label: 'Billing Address', checked: true },
    { id: '27', label: 'Shipping Address', checked: true },
    { id: '28', label: 'Status', checked: true },
    { id: '29', label: 'Action', checked: true },
  ]);
  ...
  const customerss = useAppSelector((state: RootState) => state.customer.customers);



  console.log("Total number of customers:", customerss.length);
  ...
  return (
    ...
    <>
      ...
      <div
        id="offcanvas-right"
        className={`hs-overlay fixed top-0 end-0 transition-all duration-300 transform h-full  w-[350px]   md:w-[500px]  z-[80] bg-white border-l dark:bg-neutral-800 dark:border-neutral-700 ${isOpenFilter ? "translate-x-0" : "translate-x-full"}`}
        role="dialog"
        aria-labelledby="offcanvas-right-label"
      >
        <div className="flex justify-between items-center py-5 px-4 border-b dark:border-neutral-700">
          <h3
        ...
        <div className="p-4 mt-5 overflow-y-auto  max-h-[calc(100vh-4rem)]">
          <FilterSupplier />
        </div>
      ...
      <div
        id="offcanvas-right"
        className={`hs-overlay fixed top-0 end-0 transition-all duration-300 transform h-full  w-[350px]   md:w-[500px]  z-[80] bg-white border-l dark:bg-neutral-800 dark:border-neutral-700 ${isOpen ? "translate-x-0" : "translate-x-full"}`}
        role="dialog"
        aria-labelledby="offcanvas-right-label"
      >
        <div className="flex justify-between items-center py-5 px-4 border-b dark:border-neutral-700">
        ...
        <div className="p-4 mt-5 mb-5 overflow-y-auto  max-h-[calc(100vh-4rem)]">
...
<div className='w-full pl-[1.5%] pr-[3%]'>



      {/* Search and Dropdown Toggle Section */}
      <div className="pb-4 mt-5   mb-3 flex flex-col gap-9  ">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="font-semibold text-[20px]"> All Supplier </h2>
            <div className='text-gray-500 mt-2  gap-1 font-medium  items-center flex text-sm  '>
              <h3>Customer</h3>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
          ...
          <div className="flex items-center">
            <button
              className="flex items-center  font-medium gap-1 px-4 py-2 text-white bg-orange-500 rounded-md hover:bg-orange-600 transition duration-300"
            >
        ...
        <div className='flex justify-between '>
          <div className="relative  sm:w-[240px] md:w-[320px]">
            <input
              type="text"
              className="text-[14px] font-mono font-normal text-gray-500 border rounded-md px-10 outline-none py-2 w-full focus:ring-1 focus:ring-orange-400 hover:ring-1 hover:ring-orange-300 focus:border-orange-400 hover:border-orange-300"
            ...
            <>
              <div>
                <button
                  ...
                  onClick={filterOffcanvas}
                  className="group flex items-center gap-2 px-3 py-2 font-medium text-gray-800 bg-white border border-gray-300 rounded transition-colors hover:border-orange-500"
                >
                  {/* Filter Icon */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 text-gray-800 transition-colors group-hover:text-orange-500"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth="2"
                  ...
                  {/* Button Text */}
                  {/* <span className="text-gray-800 transition-colors group-hover:text-orange-500">Filters</span> */}
                </button>
              </div>

              <div>
                <button
                  className="group py-2 px-3 mr-4 flex items-center gap-2 justify-center rounded border border-gray-300 cursor-pointer transition-colors hover:border-orange-500"
                  aria-haspopup="dialog"
      ...
      <div className="relative">
        <div className="overflow-x-auto w-full shadow-md sm:rounded-md">
              ...
              <tr className=' '>
                {customersdata.map((item) => {
                  if (item.checked) {
                    switch (item.label) {
                      case 'Customer ID':
                        return <th key={item.id} className="px-10 py-3">SupplierID</th>;
                      case 'Customer (Image, Name, Designation)':
                        return <th key={item.id} className="px-11 py-3">Supplier</th>;
                      case 'Phone':
                        return <th key={item.id} className="px-12 py-3">Phone</th>;
                      case 'Paid':
                        return <th key={item.id} className="px-10 py-3">Paid</th>;
                      case 'Due':
                        return <th key={item.id} className="px-10 py-3">Due</th>;
                      case 'Status':
                        return <th key={item.id} className="px-10 py-3">Status</th>;
                      default:
                        return null;
                    }
                  }
                ...
                <tr key={customer.id} className="bg-white border-b hover:bg-gray-50">
                  {customersdata.map((item) => {
                    if (item.checked) {
                      switch (item.label) {
                        case 'Customer ID':
                          return <td key={item.id} className="px-11 py-4">{customer.supplierId}</td>;
                        case 'Customer (Image, Name, Designation)':
                          return (
                            <td key={item.id} className="px-10 py-4 flex">
                              <Image
                        ...
                        case 'Phone':
                          return <td key={item.id} className="px-12 py-4">{customer.phone}</td>;
                        case 'Paid':
                          return <td key={item.id} className="px-10 py-4">{customer.paid}</td>;
                        case 'Due':
                          return <td key={item.id} className="px-10 py-4">{customer.due}</td>;
                        case 'Status':
                          return (
                            <td key={item.id} className="px-10 py-4">
                              <div
                  ...
                  <td className="flex px-10 py-4 items-center gap-0.5">
