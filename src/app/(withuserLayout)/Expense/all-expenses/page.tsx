          ...
          <table className="w-full border text-sm text-left text-gray-700">
            <thead className="border-b text-gray-600 text-[13px] uppercase bg-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-3">Expense Amount</th>
                        ...
                        <tbody>
                            {expenseCategories.map((category) => (
                                <tr key={category.id} className="bg-white border-b hover:bg-gray-50">
                                    <td className="px-6 py-4 text-gray-500">{category.expenseId}</td>
                                    <td className="px-6 py-4 text-gray-500">{category.expenseFor}</td>
                                    <td className="px-6 py-4 text-gray-500 ">{category.expenseCategory}</td>
                                    <td className="px-6 py-4">{category.expenseDate}</td>
                                    <td className="px-6 text-indigo-600 font-medium  py-4">${category.expenseAmount}</td>
